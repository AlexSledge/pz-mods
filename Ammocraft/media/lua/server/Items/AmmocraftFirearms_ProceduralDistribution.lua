...
for i = 1, #myDistTableBoxes, 2 do
  ...
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, "Base.4440Bullets_casingbox")
  ...
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, "Base.762Bullets_casingbox")
  ...
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, myDistTableBoxes[i+1])
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, "Base.4440Bullets_tipbox")
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, myDistTableBoxes[i+1]/2)
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, "Base.762Bullets_tipbox")
  table.insert(ProceduralDistributions.list[myDistTableBoxes[i]].items, myDistTableBoxes[i+1]/4)
end
